...
List<TravelDestination> myDestination = [
  ...
  TravelDestination(
    ...
    category: 'recommend',
    image: [
      "https://i0.wp.com/www.littlethingstravel.com/wp-content/uploads/2017/08/Wat-Thai-Temple-Lumbini-Nepal.jpg?w=2000&ssl=1",
  ...
  TravelDestination(
    ...
    image: [
      ...
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQL0MuX9OkCYwNIYGAJxHG3lW7sA07g7e1Vdw&s"
    ],
    location: "Mugu, Nepal",
    description: description,
    rate: 4.5,
  ...
  TravelDestination(
    ...
    image: [
      ...
      "https://upload.wikimedia.org/wikipedia/commons/6/69/Durbar_Square%2C_Kathmandu.jpg"
    ],
    location: "Kathmandu, Nepal",
    description: description,
    rate: 4.7,
